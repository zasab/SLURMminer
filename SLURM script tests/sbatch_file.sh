...
JOB_ID_16=$(sbatch --parsable --dependency=afterok:$JOB_ID_5 srun_file16.sh)
JOB_ID_17=$(sbatch --parsable --dependency=afterok:$JOB_ID_16 srun_file17.sh)
JOB_ID_18=$(sbatch --parsable --dependency=afterok:$JOB_ID_5 srun_file18.sh)
JOB_ID_19=$(sbatch --parsable --dependency=afterok:$JOB_ID_18 srun_file19.sh)
JOB_ID_10=$(sbatch --parsable --dependency=afterany:$JOB_ID_9:$JOB_ID_7,afterany:$JOB_ID_17:$JOB_ID_19 srun_file10.sh)
