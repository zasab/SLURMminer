...
noise_threshold = float(inputs_dict['model_info2']['noise_threshold'])
...
#------------------------------------------------- outputs
if output_file:
    command_parser.output_generator(os.path.join(script_dir, output_file), "fitness_token_based_replay", fitness_token_based_replay)
