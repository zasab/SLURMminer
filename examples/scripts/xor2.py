...
if 'BPI_Challenge_2013_open_problems.xes' in log_path:
    ...
    print('for BPI_Challenge_2013_open_problems.xes successfully pass to next task ..........')
    sys.exit(0)
else:
    #------------------------------------------------- outputs
    if output_file:
        command_parser.output_generator(os.path.join(script_dir, output_file), 'for running-example.xes exist code 1..........')

    print('for running-example.xes exist code 1..........')
    sys.exit(1)
